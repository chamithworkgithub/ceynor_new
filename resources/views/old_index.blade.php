               ...
               <div class=" fixed-top  container-fluid">
                  <div class="row menu-1-inner justify-content-between"  >
                     <div class="col-auto menu-1-logo">
                        ...
                        <img class="nb-light" src="assets/images/ceynorlogo.png">
                        <img class="nb-dark" src="assets/images/ceynorlogo.png">
                     ...
                     <div class="col-md-7 main_nav_outer">
                        <nav class="main_nav">
                           ...
                           <div class="dropdown ">
                              <button type="button" class="btn btn-primary active" data-toggle="dropdown">
                           ...
                           <div class="dropdown">
                              <button type="button" class="btn btn-primary dropdown-toggle" href="home-1.html" data-toggle="dropdown">
                                 About Us
                              </button>
                           ...
                           <div class="sidenav_cat">
                              ...
                              <ul class="">
                                 <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="home-1.html">Home</a>
                                 ...
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Boat Yards</a>
                                    <div class="dropdown-menu">
                                 ...
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Documents & Downloads</a>
                                    <div class="dropdown-menu">
                                 ...
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Sales & Promotions</a>
                                    <div class="dropdown-menu">
                                    </div>
                                 </li>
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Tenders</a>
                                    <div class="dropdown-menu">
                                    </div>
                                 </li>
                                 <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Cantact</a>
                                    <div class="dropdown-menu">
                                    </div>
                                 </li>
                                 <li class="nav-item dropdown">
